...
('Intel Core i9-14900K', 'High-end desktop CPU', 0, 48969.17, 'Intel', (SELECT c_id FROM categories WHERE cat_name = 'Processors')),
('AMD Ryzen 7 7800X3D', 'Gaming champion CPU', 0, 37267.0, 'AMD', (SELECT c_id FROM categories WHERE cat_name = 'Processors')),
('NVIDIA RTX 4080 Super', 'High-end gaming GPU', 0, 82999.17, 'NVIDIA', (SELECT c_id FROM categories WHERE cat_name = 'Graphics Cards')),
('NVIDIA RTX 4070 Ti', 'Mid-high range GPU', 0, 66399.17, 'NVIDIA', (SELECT c_id FROM categories WHERE cat_name = 'Graphics Cards')),
('ASUS ROG Strix Z790', 'Overclocking motherboard', 0, 33117.0, 'ASUS', (SELECT c_id FROM categories WHERE cat_name = 'Core Hardware')),
('Corsair Vengeance 32GB DDR5', '6000MHz Performance RAM', 0, 10789.17, 'Corsair', (SELECT c_id FROM categories WHERE cat_name = 'Memory')),
('G.Skill Trident Z5 64GB', 'DDR5 memory kit', 0, 20749.17, 'G.Skill', (SELECT c_id FROM categories WHERE cat_name = 'Memory')),
('Samsung 990 Pro 1TB', 'PCIe 4.0 NVMe SSD', 0, 9959.17, 'Samsung', (SELECT c_id FROM categories WHERE cat_name = 'Storage')),
('Western Digital Black 4TB', 'High capacity HDD', 0, 13279.17, 'WD', (SELECT c_id FROM categories WHERE cat_name = 'Storage')),
('LG UltraGear 27GP850', '27 inch QHD Gaming Monitor', 0, 33199.17, 'LG', (SELECT c_id FROM categories WHERE cat_name = 'Monitors')),
('Dell UltraSharp 32', '4K Professional Monitor', 0, 74617.0, 'Dell', (SELECT c_id FROM categories WHERE cat_name = 'Monitors')),
('Logitech G Pro X Superlight', 'Ultra-light gaming mouse', 0, 12449.17, 'Logitech', (SELECT c_id FROM categories WHERE cat_name = 'Input Devices')),
...
('Crucial T700 2TB', 'PCIe 5.0 NVMe SSD', 0, 23239.17, 'Crucial', (SELECT c_id FROM categories WHERE cat_name = 'Storage')),
('ASUS TUF Gaming OC RTX 4090', 'Extreme 4090 GPU', 0, 165917.0, 'ASUS', (SELECT c_id FROM categories WHERE cat_name = 'Graphics Cards')),
...
('Intel Core i7-14700K', 'Performance desktop CPU', 0, 33199.17, 'Intel', (SELECT c_id FROM categories WHERE cat_name = 'Processors')),
('HyperX Cloud II', 'Gaming Headset', 0, 8217.0, 'HP', (SELECT c_id FROM categories WHERE cat_name = 'Audio')),
('MikroTik RB5009', 'Heavy-duty router', 0, 16517.0, 'MikroTik', (SELECT c_id FROM categories WHERE cat_name = 'Routers')),
('Epson EcoTank Pro', 'Supertank color printer', 0, 74617.0, 'Epson', (SELECT c_id FROM categories WHERE cat_name = 'Peripherals')),
('Blue Yeti USB Mic', 'Streaming microphone', 0, 10707.0, 'Logitech', (SELECT c_id FROM categories WHERE cat_name = 'Audio')),
('Samsung Odyssey G9', '49" Super Ultrawide', 0, 107817.0, 'Samsung', (SELECT c_id FROM categories WHERE cat_name = 'Monitors'));
